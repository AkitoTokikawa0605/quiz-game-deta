...
; ★テスト用：システム変数を強制的に消去する（確認が終わったら消してね）
;[eval exp="sf.tutorial_seen = false"]
...
[button  target="*easy_start"  graphic="button/button34.png"  enterimg="button/button34_1.png"  x="50"  y="250"  width="250"  height="450"  exp="tf.diff='easy'"  storage=""  ]
[button  target="*normal_start"  graphic="button/button35.png"  enterimg="button/button35_1.png"  x="350"  y="250"  width="250"  height="450"  exp="tf.diff='normal'"  storage=""  ]
[button  target="*hard_start"  graphic="button/button36.png"  enterimg="button/button36_1.png"  x="650"  y="250"  width="250"  height="450"  exp="tf.diff='hard'"  storage=""  ]
[button  target="*veryhard_start"  graphic="button/button37.png"  enterimg="button/button37_1.png"  x="950"  y="250"  width="250"  height="450"  exp="tf.diff='veryhard'"  storage=""  ]
[s  ]
*easy_start
...
; ボタンを押したらまず背景＆データ初期化処理へ直行！


[jump  target="*setup_game"  storage=""  ]
...
; ▼▼ 初回判定（sf.tutorial_seen が true じゃない、または false の時にジャンプ） ▼▼


[jump  cond="!sf.tutorial_seen"  target="*tutorial_scene"  storage=""  ]

; 「はい」＝チュートリアル再生 / 「いいえ」＝ウェルカム演出へ
...
クイズで遊ぼう！の世界へようこそ！[p]
クイズは全部で50種類のうちランダムで10問が出題されます[p]
...
; ★チュートリアルが終わったら、ウェルカムを飛ばしてクイズ本編へ直行！
