...
tf.all_questions = [
{q: "第1問", difficulty: "easy", choices: ["アニメ『ドラえもん』で、ドラえもんが一番大好物な<br>食べ物は何でしょう？", "A.みたらし団子", "B.どら焼き", "C.カレーライス", "D.鉄"], ans: "B", explain: "どら焼きはドラえもんの大好物として知られる和菓子。作中でも頻繁に食べており、どら焼きのために行動することも多い象徴的な食べ物。"},
...
{q: "第3問", difficulty: "easy", choices: ["『アンパンマン』の作者は誰？", "A.藤子・F・不二雄", "B.やなせたかし", "C.手塚治虫", "D.鳥山明"], ans: "B", explain: "やなせたかしは『それいけ！アンパンマン』を生み出した漫画家・絵本作家。自分の顔をちぎって分け与える独自のヒーロー像を確立した。"},
{q: "第4問", difficulty: "easy", choices: ["『名探偵コナン』の主人公、江戸川コナンが本来の姿に戻るために追っている組織は？", "A.赤の組織", "B.黒の組織", "C.白の組織", "D.青の組織"], ans: "B", explain: "黒の組織は工藤新一に試作段階の毒薬APTX4869を飲ませ、身体を幼児化させた謎の犯罪組織。全身黒づくめの衣装が特徴。"},
{q: "第5問", difficulty: "easy", choices: ["『となりのトトロ』で、サツキとメイが出会う不思議な<br>存在として正しいものは？", "A.ネコバス", "B.小トトロ", "C.まっくろくろすけ", "D.トトロ"], ans: "D", explain: "トトロは豊かな自然が残る森の主として人知れず暮らしている不思議な生き物。サツキとメイの姉妹と出会い交流を深めていく。"},
...
{q: "第8問", difficulty: "easy", choices: ["『サザエさん』の磯野家で、一番年上なのは？", "A.フネ", "B.波平", "C.サザエ", "D.カツオ"], ans: "B", explain: "磯野波平は磯野家の大黒柱で、54歳。妻のフネは50ン歳とされている。"},
...
{q: "第10問", difficulty: "easy", choices: ["『美少女戦士セーラームーン』で、主人公月野うさぎが<br>変身する決め台詞は？", "A.月に代わって<br>愛を届けるわ！", "B.月に代わって<br>おしおきよ！", "C.月のように輝くわ！", "D.月を見て戦うわ！"], ans: "B", explain: "セーラームーンに変身した月野うさぎが、敵と相対した決めポーズの際に発する代表的な決め台詞が「月に代わっておしおきよ！」。"},
...
{q: "第13問", difficulty: "easy", choices: ["『ちびまる子ちゃん』の主人公まる子の本名は？", "A.さくらさきこ", "B.さくらすみれ", "C.さくらももこ", "D.さくらともぞう"], ans: "C", explain: "「ちびまる子ちゃん」こと主人公の本名は「さくらももこ」。原作者自身の少女時代をモデルにしたエッセイ風作品となっている。"},
{q: "第14問", difficulty: "easy", choices: ["『SPY×FAMILY』で、超能力（心を読む力）を<br>持つ少女の名前は？", "A.ヨル", "B.フィオナ", "C.ベッキー", "D.アーニャ"], ans: "D", explain: "アーニャ・フォージャーは組織の実験によって他人の心を読めるようになった少女。ロイドに引き取られ仮初めの娘として生活する。"},
{q: "第15問", difficulty: "easy", choices: ["『暗殺教室』で、3年E組の担任を務める<br>黄色いタコ型の超生物は？", "A.殺せんせー", "B.烏間先生", "C.ビッチ先生", "D.死神"], ans: "A", explain: "最高速度マッハ20で移動する謎の超生物で、生徒たちから「殺せない先生」にちなんで「殺せんせー」と命名された。"},
...
{q: "第17問", difficulty: "easy", choices: ["『僕のヒーローアカデミア』で、主人公の緑谷出久が<br>受け継いだ個性の名前は？", "A.オール・フォー・ワン", "B.爆破", "C.ワン・フォー・オール", "D.半冷半燃"], ans: "C", explain: "「ワン・フォー・オール」は力をストックし人から人へ引き継ぐ能力。無個性だった緑谷出久はオールマイトからこの能力を受け継いだ。"},
...
{q: "第21問", difficulty: "normal", choices: ["『呪術廻戦』で、虎杖悠仁が受肉することになった<br>特級呪物は？", "A.両面宿儺の指", "B.獄門疆", "C.特級過呪怨霊", "D.天逆鉾"], ans: "A", explain: "両面宿儺の指は特級呪物で、虎杖が飲み込んだことで受肉した。"},
...
{q: "第23問", difficulty: "normal", choices: ["『君の名は。』の監督は誰？", "A.新海誠", "B.宮崎駿", "C.細田守", "D.庵野秀明"], ans: "A", explain: "新海誠は緻密な風景描写と繊細な人間ドラマで知られる映画監督。2016年に公開された『君の名は。』は大ヒットを記録し代表作となった。"},
...
{q: "第30問", difficulty: "normal", choices: ["『ジョジョの奇妙な冒険』の第1部の主人公は？", "A.ジョナサン・<br>ジョースター", "B.空条承太郎", "C.ジョセフ・<br>ジョースター", "D.東方仗助"], ans: "A", explain: "ジョナサン・ジョースターは第1部『ファントムブラッド』の主人公。宿敵ディオ・ブランドーとの因縁から始まる壮絶な物語を描いた。"},
...
{q: "第34問", difficulty: "normal", choices: ["『ソードアート・オンライン』の主人公キリトがゲーム内で呼ばれていた二つ名は？", "A.閃光", "B.絶剣", "C.黒の魔王", "D.黒の剣士"], ans: "D", explain: "キリトは黒を基調とした装備を愛用し、ソロで前線に立ち続けたことから「黒の剣士」という二つ名で恐れられ親しまれた。"},
...
{q: "第36問", difficulty: "normal", choices: ["『シュタインズ・ゲート』で、<br>主人公・岡部倫太郎が自称する二つ名は？", "A.閃光のルルーシュ", "B.鳳凰院凶真", "C.漆黒の翼", "D.漆黒のフォトン"], ans: "B", explain: "岡部倫太郎は重度の厨二病であり、自らを狂気の狂気のマッドサイエンティスト「鳳凰院凶真（ほうおういんきょうま）」と名乗っている。"},
{q: "第37問", difficulty: "normal", choices: ["『五等分の花嫁』で、五つ子の中で長女（一番上）は誰？", "A.二乃", "B.三玖", "C.一花", "D.四葉"], ans: "C", explain: "中野家のアニメや原作における長女は中野一花（いちか）。五つ子の中ではお姉さん気質で、面倒見が良い性格をしている。"},
...
{q: "第41問", difficulty: "hard", choices: ["『CLANNAD』で、古河渚が大好きな歌は？", "A.ウサギファミリー", "B.だんご大家族", "C.クマのパン屋さん", "D.ヒトデ一家"], ans: "B", explain: "「だんご大家族」は作中に登場する大人気キャラクターソング。ヒロインの古河渚が非常に気に入っており、作中でも印象的に歌われる。"},
...
{q: "第43問", difficulty: "hard", choices: ["『Mob Psycho 100（モブサイコ100）』の<br>主人公・影山茂夫が通う中学校の名前は？", "A.塩中学校", "B.黒酢中学校", "C.味の素中学校", "D.醤油中学校"], ans: "A", explain: "主人公のモブこと影山茂夫が通っている学校は「塩中学校」。ライバル校として「黒酢中学校」などの調味料にちなんだ学校が登場する。"},
...
{q: "第49問", difficulty: "hard", choices: ["『寄生獣』の主人公、泉新一の右手に寄生した<br>ミギーの主な栄養源は？", "A.人間", "B.新一の血液", "C.動物の肉", "D.植物"], ans: "B", explain: "ミギーは脳への侵入に失敗して新一の右手に寄生したパラサイト。宿主である新一の血液から流れてくる栄養分を得て生存している。"},
{q: "第50問", difficulty: "hard", choices: ["『天元突破グレンラガン』で、<br>カミナが愛用している武器は？", "A.拳銃", "B.ハンマー", "C.槍", "D.大刀"], ans: "D", explain: "大グレン団の初代リーダーであるカミナは、身の丈を超えるほど非常に長い大刀（日本刀）を愛用し、戦闘や指揮を執る際に振るった。"},
...
{q: "第52問", difficulty: "hard", choices: ["『MONSTER』で、ヨハン・リーベルトと<br>双子の妹アンナが生まれた国は？", "A.東ドイツ", "B.西ドイツ", "C.オーストリア", "D.チェコスロバキア"], ans: "D", explain: "物語の鍵を握る双子（ヨハンとアンナ）は、かつてのチェコスロバキア（プラハ）で出生した設定になっている。"},
{q: "第53問", difficulty: "hard", choices: ["『宝石の国』で、主人公フォスフォフィライトの硬度は？", "A.5.5", "B.7", "C.10", "D.3.5"], ans: "D", explain: "フォスフォフィライトはモース硬度が「3.5」と非常に脆く、衝撃に弱い身体のため他の宝石たちのような戦闘に向かない悩みを持っていた。"},
...
{q: "第55問", difficulty: "hard", choices: ["『少女革命ウテナ』で、ウテナが所属する学園の名称は？", "A.星ノ森学園", "B.聖マリア学園", "C.常盤台中学", "D.鳳学園"], ans: "D", explain: "天上ウテナが転校してきた「鳳学園」は、男装の彼女が「薔薇の嫁」と呼ばれる生徒姫宮アンシーを巡る決闘に巻き込まれる舞台となる。"},
{q: "第56問", difficulty: "hard", choices: ["『serial experiments lain』の主人公、<br>玲音が最初に使用していたコンピューターは？", "A.iMac", "B.NAVI", "C.VAIO", "D.PC-98"], ans: "B", explain: "作品世界において情報端末は「NAVI（ナビ）」と呼ばれており、玲音が初期に使用していたのは児童向けデザインの赤いNAVIだった。"},
{q: "第57問", difficulty: "hard", choices: ["『交響詩篇エウレカセブン』で、ゲッコーステイトの<br>リーダーであり、月光号の艦長を務める人物は？", "A.タルホ・ユーキ", "B.デューイ・ノヴァク", "C.ホランド・ノヴァク", "D.アネモネ"], ans: "C", explain: "ホランド・ノヴァクは反政府組織「ゲッコーステイト」のリーダーで月光号の艦長。主人公レントンが憧れる卓越したLFOパイロット。"},
{q: "第58問", difficulty: "hard", choices: ["『化物語』で、主人公の阿良々木暦が最初に助けた<br>吸血鬼の“完全体の呼称”は？", "A.キスシップ", "B.忍野忍", "C.キスショット", "D.エピソード"], ans: "C", explain: "キスショットは忍野忍の本来の名前で、作中で重要な役割を持つ吸血鬼の完全体の呼称。"},
{q: "第59問", difficulty: "hard", choices: ["『血界戦線』で、主人公レオナルド・ウォッチが持つ<br>「神々の義眼」と引き換えに視力を失った妹の名前は？", "A.ホワイト", "B.ミシェーラ", "C.チェイン", "D.K・K"], ans: "B", explain: "ミシェーラはレオナルドの妹。謎の存在から提示された対価として、兄のかわりに自身の視力を差し出すことで兄に義眼をもたらした。"},
...
{q: "第61問", difficulty: "veryhard", choices: ["『SHIROBAKO』で、主人公・宮森あおいが<br>武蔵野アニメーションで就いている役職は？", "A.原画作画", "B.3D監督", "C.制作進行", "D.音響監督"], ans: "C", explain: "宮森あおいはアニメ制作会社「武蔵野アニメーション」で制作進行を担当。スケジュール管理や各セクションとの調整に日々奮闘する。"},
...
{q: "第65問", difficulty: "veryhard", choices: ["『輪るピングドラム』の監督は誰？", "A.細田守", "B.湯浅政明", "C.幾原邦彦", "D.今敏"], ans: "C", explain: "幾原邦彦は独自の演出スタイルと象徴的な映像美で知られるアニメーション監督。『少女革命ウテナ』に続き本作でも監督を務めた。"},
...
{q: "第69問", difficulty: "veryhard", choices: ["『地球へ…』の原作者は？", "A.萩尾望都", "B.大島弓子", "C.竹宮惠子", "D.山岸凉子"], ans: "C", explain: "竹宮惠子は日本の漫画家。『地球へ…』は1970年代に連載されたSF金字塔作品であり、劇場アニメやTVアニメとして映像化された。"},
...
{q: "第76問", difficulty: "veryhard", choices: ["『電脳コイル』で、電子ペットや電脳物質を駆除・消去する行政の防衛プログラムの名前は？", "A.イリーガル", "B.ヌル", "C.サッチー", "D.キュウちゃん"], ans: "C", explain: "「サッチー（正式名称：サーチトン）」は市役所の郵政局が管轄するアンチウイルスプログラム。違法な電脳バグを容赦なくフォーマットする。"},
...
[iscript]
// ジャンル名を 'animation' に統一
tf.current_genre = 'animation';

var key_normal   = tf.current_genre + '_normal';   // animation_normal
var key_hard     = tf.current_genre + '_hard';     // animation_hard
var key_veryhard = tf.current_genre + '_veryhard'; // animation_veryhard
...
if (tf.diff === 'easy' && !sf[key_normal]) {
    sf[key_normal] = true; // sf.animation_normal = true になる
